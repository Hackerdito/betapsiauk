...
const Navbar: React.FC<NavbarProps> = ({ currentPage, onNavigate, user, onLogout, onLogin }) => {
          ...
          <div className="flex flex-col p-8 gap-6 items-center">
            {!user ? (
              currentPage === 'home' ? (
                <>
                  <button 
                    ...
                    className="text-white text-lg font-medium w-full py-4 border-b border-white/10"
                  >
                    Iniciar Sesión
                  </button>
                  <button 
                    ...
                    className="bg-brand-orange hover:bg-orange-600 text-white text-lg font-bold py-4 w-full rounded-xl transition-colors shadow-lg"
                  >
                    Suscribete Aquí
                  </button>
                </>
                ...
                <button 
                  ...
                  className="border border-white text-white text-lg font-bold py-4 w-full rounded-xl transition-colors"
                >
                  Home
                </button>
              )
              ...
              <div className="w-full flex flex-col gap-4">
                ...
                <button className="w-full text-white text-left px-4 py-4 border-b border-white/5 flex items-center gap-3">
                ...
                <button 
                  ...
                  className="w-full text-red-500 text-left px-4 py-4 flex items-center gap-3"
                >
